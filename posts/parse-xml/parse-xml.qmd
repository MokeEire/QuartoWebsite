...
At its core, XML is just "information wrapped in tags". Here is an example of a bookstore's data in XML format from [w3schools](https://www.w3schools.com/XML/xml_usedfor.asp) :
